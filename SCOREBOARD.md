...
## Champion
- **dp2_8s_fw_4acc_t0_64_768 (PROMOTED 2026-07-20, current — ×194)** — `4 independent u16 accumulators per pair of streams + T0@64B (1 iter, L2→L1) + T1@768B (12 iters, DRAM→L2) per stream; judge-tuned for ~80ns DRAM`
