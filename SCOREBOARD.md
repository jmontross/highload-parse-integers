...
## Champion
- **dp2_8s_fw_t0_2048 (RE-PROMOTED 2026-07-15, current — ×143, confirmed STOP-FLOOR ×143)** — `double-loop + T0@512B (8 iters, L2→L1) + T1@2048B (32 iters, DRAM→L2) per stream; single u16 accumulator`
