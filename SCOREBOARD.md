...
## Champion
- **dp2_8s_fw_4acc_t0_128_1024 (PROMOTED 2026-07-15, current — ×139, confirmed STOP-FLOOR ×139)** — `4 independent per-pair u16 accumulators + T0@128B (2 iters, L2→L1) + T1@1024B (16 iters, DRAM→L2) per stream`
