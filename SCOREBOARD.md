...
- **dp2_8s_fw_t0_192_1536 (PROMOTED 2026-07-14, current — ×126, confirmed ×127-128)** — `T0@192B + T1@1536B; judge-tuned shorter prefetch distances (T0=3 iters, T1=24 iters for ~80-100ns DRAM)`
  ...
  STOP-FLOOR ×129 (2026-07-14, RUNS=3, floor=0.279s): champion 0.078s best/0.081s median. All 159 cpp variants benchmarked. Best variant: dp2_8s_fw_t0_128_1024 best=0.077s (1.28% margin, need ≥1.5%) → HOLD. No new variants tried — all obvious directions exhausted (prefetch distances, stream counts, accumulator structures, interleaving all explored over 128+ runs). index.html: 78ms (medium VM, 1.1× off rank-18 bar of 69.3ms). Edge 9/9.
  **SUBMIT `champion/main.cpp` with `g++ -O3 -march=native`.**
  Expected judge time: ~60-70ms. index.html: 78ms (medium VM, floor=0.279s).
