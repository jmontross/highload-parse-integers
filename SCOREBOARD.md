...
Champion (dp2_8s_fw_4acc_t0t1) at 0.064-0.090s (VM-dependent) — mmap+hugepage bypasses kernel read path entirely; fully bandwidth-bound. g++-13 -O3 -march=native best.

## Champion
- **dp2_8s_fw_4acc_t0t1 (PROMOTED 2026-07-22, superseded dp2_8s_fw_3072_32 at ×220)** — `4 independent per-pair u16 accumulators + T0@512B (8 iters, L2→L1) + T1@3072B (48 iters, DRAM→L2) per stream`
