...
## Champion
- **dp2_8s_fw_t0_2048 (PROMOTED 2026-07-13, current)** — `double-loop + two-tier prefetch: T0@512B (near, L1) + T1@2048B (far, L2) per stream`
  ...
  **SUBMIT `champion/main.cpp` with `g++-13 -O3 -march=native`.**
  Expected judge time: ~60-70ms (fast-VM best 0.075s → ~60-65ms). index.html: 77.0ms (slow VM confirmation).
