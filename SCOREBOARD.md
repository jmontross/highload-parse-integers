...
## Champion
- **dp2_8s_fw_t0_128_3072 (PROMOTED 2026-07-14, current — ×134, confirmed STOP-FLOOR ×134)** — `double-loop + T0@128B (2 iters, L2→L1) + T1@3072B (48 iters, DRAM→L2) per stream`
  — Gate ×134 (RUNS=3, floor=0.266s min/0.590s median medium-slow VM): t0_128_3072 best=0.091s vs champion (fw_2048_32) 0.094s → 3.2% margin, median 0.091s < 0.110s → PROMOTE. Edge 9/9. Promoted. Confirmation ×134 (RUNS=5, floor=0.562s slow VM): new champion best=0.092s, median=0.095s; best variant (dp2_8s_fw_t0_t1) best=0.091s but median=0.095s (tied) → HOLD → STOP-FLOOR ×134. All 159 cpp variants correct (1 WRONG: dp2_8s_u8tree). Edge 9/9. Compiler sweep: g++ -O3 -march=native → 0.092s best; clang++ 18 0.101s (slower). New variants this session: dp2_8s_fw_t0_64_2048 (T0@64+T1@2048, best=0.092s HOLD — tied on best, median=0.093s > 0.095s old champ), dp2_8s_fw_t0_96_1536 (T0@96+T1@1536, best=0.095s HOLD).
