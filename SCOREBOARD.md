...
## Champion
- **dp2_8s_fw_4acc_t0_64_512 (PROMOTED 2026-07-15, current — ×141, confirmed STOP-FLOOR ×141)** — `4 independent per-pair u16 accumulators + T0@64B (1 iter, L2→L1) + T1@512B (8 iters, DRAM→L2) per stream; judge-tuned for ~80ns DRAM`
