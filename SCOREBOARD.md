...
Champion (dp2_8s_fw_t0_128_512) at 0.063-0.083s (VM-dependent) — mmap+hugepage bypasses kernel read path entirely; fully bandwidth-bound. g++ -O3 -march=native best. Best observed: 0.063s = 1.26 ns/line = 1.00× floor (CLEARS rank-18 bar ≤69.3ms).
