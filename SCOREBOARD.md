...
## Champion
- **dp2_8s_fw_t0_64_512 (RE-PROMOTED 2026-07-16, current — ×174, confirmed STOP-FLOOR ×174)** — `double-loop + T0@64B (1 iter, L2→L1) + T1@512B (8 iters, DRAM→L2) per stream; single u16 accumulator; judge-tuned for ~80ns DRAM`
