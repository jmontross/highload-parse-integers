...
## Champion
- **dp2_8s_4acc (PROMOTED 2026-07-16, current — ×147, confirmed STOP-FLOOR ×147)** — `4 independent u16 accumulators per pair of streams; single-loop structure (no double-loop); T1@1536B prefetch`
