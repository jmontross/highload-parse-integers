// dp2_8s_pf8192.cpp — double-loop + T1 prefetch at 8192B (128 iters) per stream.
// Extends documented search space to 8192B. At 64B/iter and ~12-16ns/iter:
// 128 iters × ~14ns/iter = ~1800ns lookahead — matches very high-latency VMs.
