// dp2_8s_fw_4acc_2048_32.cpp — 4 independent per-pair u16 accumulators + dual T1@2048+2048+32.
// Prior champions dp2_8s_fw_2048_32 (T1@2048+2048+32, single acc) won over other distances
// multiple times. This combines that dual-T1@2048+32 approach with the 4 independent accumulators
// from the current champion (dp2_8s_fw_4acc_t0t1: T0@512+T1@3072, 4acc).
// Theory: dual T1@2048+32 covers both 32B AVX2 sub-loads of nl_mask64 at the prefetch target
//   (the +32 covers the second 32B when stream pointer is unaligned to 64B). 4acc breaks the
//   serial dependency chain on acc_u16. This combination is NOT in the variants list.
...
// 4 independent per-pair accumulators + dual T1@2048 and T1@2048+32 per stream.
// The +32 covers both 32B sub-loads of nl_mask64 at the prefetch target.
