// dp2_8s_unify_stop.cpp — dp2_8s_subdetect with unified loop termination.
// Replaces 8-way `p0<s0 & p1<s1 & ... & p7<s7` AND condition with a single
// pre-computed iteration counter safe_iters = (min_segment_len - 96) / 64.
