// dp2_8s_fw_t0_64_256.cpp — judge-optimized two-tier: T0@64B + T1@256B.
// Judge DRAM ~80ns = ~240cy at 3GHz; iteration ~33cy → T1 at ~4 iters=256B (judge-optimal if ~60cy/iter).
// T0@64B (1 iter ahead): just-in-time L2→L1 warm for each 64B fetch.
// T1@256B: covers DRAM latency on judge (~80ns, vs VM's ~400ns).
