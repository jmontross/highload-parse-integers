// dp2_8s_fw_4acc_t0_512_4096.cpp — 4acc + T0@512B (near, L2→L1) + T1@4096B (far, DRAM→L2).
// T1@4096B = 64 iters ahead. Single-acc dp2_8s_fw_t0_4096 was HOLD ×108 (1.3% margin,
// below 1.5% gate). 4acc + T1@4096 is unexplored — may combine 4acc serial-chain relief
// with longer prefetch lookahead for DRAM→L2 fill.
