// dp2_8s_fw_4096_64.cpp — double-loop + dual T1 prefetch per stream at p+4096 AND p+4096+64
// dual T1 prefetch per stream at p+4096 AND p+4096+32 (from dp2_8s_pf3072_32).
// Untested combination: fixed_3072 used single prefetch; pf3072_32 used single-loop.
// nl_mask64 does two 32B AVX2 loads at p and p+32; when (p+4096)%64 >= 32,
