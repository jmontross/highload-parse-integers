// dp2_8s_fw_4acc_t0_256_512.cpp — 4 independent accumulators + T0@256B + T1@512B.
// Judge-optimized T1: DRAM ~80ns at 3GHz = 240cy; 8 iters × ~30cy/iter = 240cy.
// 4acc breaks serial dependency chain (4-deep → 4 independent chains).
// T1@512B targets bare-metal judge; will appear slow on VM (~400ns DRAM = 3-5× too short).
// Fills 4acc × T0@256 × T1@512 gap (tried: 4acc×T0@64×T1@512, 4acc×T0@256×T1@2048+).
// Overflow: 1 pair × 108/lane × 100 iters = 10,800 < 65,535 per acc ✓.
