// dp2_8s_fw_4acc_t1only_640.cpp — 4 independent per-pair u16 accumulators + T1@640B ONLY.
// Champion dp2_8s_fw_4acc_t0_64_640 uses T0@64B (1 iter) + T1@640B (10 iters).
// This variant removes all T0 prefetches — saves 8 µops/iter.
// Theory: HW stream prefetcher covers the next cache line (T0-range) adequately
// for sequential-ish per-stream access. T1@640B ensures DRAM pipelining.
// Removing T0 frees dispatch ports; the question is whether T0 was helping or just pressure.
...
// T1@640B only per stream — no T0 prefetch. Saves 8 µops/iter vs champion.
