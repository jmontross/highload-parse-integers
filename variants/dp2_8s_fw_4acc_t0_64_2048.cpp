// dp2_8s_fw_4acc_t0_64_2048.cpp — 4 independent per-pair u16 accumulators + T0@64+T1@2048.
// Judge tuning: T0@64B (1 iter, L2→L1) + T1@2048B (32 iters ahead, DRAM->L2).
// Judge (~80ns DRAM, 3GHz): 80ns × 3GHz = 240cy; 32 iters × 21cy = 672cy, VM-tuned for 300-400ns DRAM.
// 1024B = 1.33× above theoretical min for LFB headroom for judge: DRAM latency / cycles_per_iter × cache_line_size.
// Gap between champion T1@1024B and T1@3072B.
