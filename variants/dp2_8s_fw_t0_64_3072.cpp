// dp2_8s_fw_t0_64_3072.cpp — champion with T0@64B (very near) + T1@3072B.
...
// This variant: T0@64B + T1@3072B (champion far distance, but very close T0).
// Theory: T0@64B (1 iter ahead) avoids evicting L1 from the current 64B window.
// May be better on judge (shorter latency to DRAM) vs slow-VM (needs more lookahead).
