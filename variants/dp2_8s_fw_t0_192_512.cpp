// dp2_8s_fw_t0_192_512.cpp — double-loop + two-tier prefetch, SHORTER DISTANCES.
// T0@192B (3 iters=24ns, L1) + T1@512B (8 iters=64ns, aggressive judge-tuned DRAM prefetch).
...
// One iteration body: T0@192B (3 iters=24ns, L1) + T1@512B (8 iters=64ns, aggressive judge-tuned DRAM prefetch).
