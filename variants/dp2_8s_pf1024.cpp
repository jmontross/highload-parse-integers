...
static uint64_t solve(const unsigned char* data, size_t size) {
...

    {
        ...
        while (__builtin_expect(p0 < s0 & p1 < s1 & p2 < s2 & p3 < s3 &
            ...
            _mm_prefetch((const char*)(p0 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p1 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p2 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p3 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p4 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p5 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p6 + 1024), _MM_HINT_T1);
            _mm_prefetch((const char*)(p7 + 1024), _MM_HINT_T1);
