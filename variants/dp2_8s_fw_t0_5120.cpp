// dp2_8s_fw_t0_5120.cpp — double-loop + two-tier prefetch per stream:
// T0@512B (8 iters ahead, L2→L1) + T1@5120B (80 iters ahead, DRAM→L2).
// T1@4096 was 1.3% under gate; T1@5120 extends far-tier one step further.
// Theory: DRAM latency on cloud VMs may exceed 3072B lookahead; 5120B gives
// 80 iters × 64B = 5120B, covering ~120ns at 3 GHz × 64B/line.
