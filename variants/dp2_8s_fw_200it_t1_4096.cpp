// dp2_8s_fw_200it_t1_4096.cpp — champion (200it, 4acc) with T1@4096 instead of T1@3072.
// Champion uses T0@512 (L1, near) + T1@3072 (L2, far ~62ns lookahead).
// T1@4096 gives ~83ns lookahead — more coverage for DRAM latency on judge (~60-80ns).
// If judge DRAM latency > 62ns, more lookahead may expose more MLP.
// Overflow: 200 × 108/lane = 21,600 < 65,535 per u16 lane ✓.
