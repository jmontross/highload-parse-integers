// dp2_8s_fw_t0_64_128_512.cpp — judge-optimized two-tier: T0@64B + T1@512B.
...
// T0@64B + T0@128B (dual near-tier L1) + T1@512B.
// T0@64B covers iter+1, T0@128B covers iter+2 — insurance for variable L2->L1 latency.
