// dp2_8s_fw_4acc_t0_64_640.cpp — 4 independent per-pair u16 accumulators + T0@64+T1@640.
// Judge tuning: T0@64B (1 iter, L2→L1) + T1@640B (10 iters ahead, DRAM→L2).
// Judge (~80ns DRAM, 3GHz): 80ns × 3GHz = 240cy; 10 iters × ~24cy/iter = 240cy → exact match.
// Gap between tried T1@512B (champion) and T1@2048B; 640B is first unexplored step.
