// dp2_8s_fw_t0_4096.cpp — double-loop + two-tier prefetch per stream:
// T0@512B (8 iters ahead, L2→L1) + T1@4096B (64 iters ahead, DRAM→L2).
// vs champion T1@3072B: longer T1 tested for VMs with higher DRAM latency.
// Prior dp2_8s_fw_4096_32 (T1@4096+T1@4096+32, no T0) was HOLD.
// This adds T0@512 to match champion near-tier while extending far-tier to 4096B.
