// dp2_8s_fw_t0_256_1536.cpp — double-loop + T0@256B (4 iters) + T1@1536B (24 iters).
// T0 slightly farther than champion (192B). Tests if 256B near-prefetch gives L1
// more settling time on the judge. T1 unchanged from champion.
...
// T0@256B (4 iters, near L1) + T1@1536B (24 iters, far L2).
