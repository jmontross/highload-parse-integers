// dp2_8s_fw_t0_96_1536.cpp — two-tier: T0@96B + T1@1536B.
// T0@96B: 1.5 iters ahead, slightly more L2→L1 buffer than T0@64B.
// T1@1536B: 24 iters ahead, same as judge-tuned champion dp2_8s_fw_t0_192_1536 far-tier.
// Fills gap between T0@96_768 (too short T1) and T0@192_1536 (longer T0).
...
// T0@96B (L2→L1, ~1.5 iters) + T1@1536B (DRAM→L2, 24 iters) per stream.
