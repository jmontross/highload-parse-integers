// dp2_8s_u8tree.cpp — same as dp2_8s_fixed_widen but with full u8 tree
// reduction across all 8 streams before widening to u16.
// Current champion: 4 × (add_epi8 + cvtepu8_epi16 + add_epi16) per ITER_BODY.
// This variant: 6 × add_epi8 + 1 × cvtepu8_epi16 + 1 × add_epi16.
// Saves 3 port-5 ops (cvtepu8_epi16) per ITER_BODY at cost of 2 extra add_epi8.
// Safety: per iter max u8 per lane = 8 × 9 = 72 < 255; u16 after 100 iters = 7200 < 65535.
...
#define ITER_BODY(PFD) \
    ...
    { \
    __m128i s01   = _mm_add_epi8(r0, r1); \
    __m128i s23   = _mm_add_epi8(r2, r3); \
    __m128i s45   = _mm_add_epi8(r4, r5); \
    __m128i s67   = _mm_add_epi8(r6, r7); \
    __m128i s0123 = _mm_add_epi8(s01, s23); \
    __m128i s4567 = _mm_add_epi8(s45, s67); \
    acc_u16_add(acc_u16, _mm_add_epi8(s0123, s4567)); \
    } \
    }
