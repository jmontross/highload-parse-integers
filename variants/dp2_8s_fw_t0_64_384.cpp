// dp2_8s_fw_t0_64_384.cpp — judge-optimized two-tier: T0@64B + T1@384B.
// Judge DRAM ~80ns = ~240cy at 3GHz; iteration ~33cy → T1 at ~6 iters=384B.
// T0@64B (1 iter ahead): just-in-time L2→L1 warm for each 64B fetch.
// T1@384B: covers DRAM latency on judge (~80ns, vs VM's ~400ns).
