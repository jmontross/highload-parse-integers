// dp2_8s_fw_t0_64_448.cpp — judge-optimized two-tier: T0@64B + T1@448B.
// Judge DRAM ~80ns = ~240cy at 3GHz; iteration ~33cy → T1 at ~7 iters=448B.
// T0@64B (1 iter ahead): just-in-time L2→L1 warm for each 64B fetch.
// T1@448B: covers DRAM latency on judge (~80ns, vs VM's ~400ns).
