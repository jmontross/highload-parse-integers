// dp2_8s_fw_2w_4096 — dual T1@4096 AND T1@4096+32 per stream (from 2w champion).
// Tests if a longer prefetch distance (4096B vs 3072B) gives better DRAM latency
// hiding while still covering both sub-loads of nl_mask64 across cache-line bounds.
