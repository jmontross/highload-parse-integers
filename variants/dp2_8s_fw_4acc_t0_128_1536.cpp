// dp2_8s_fw_4acc_t0_128_1536.cpp — 4 independent per-pair u16 accumulators + T0@128+T1@1536.
// 4acc version of the current champion (dp2_8s_fw_t0_128_1536).
// T0@128B (2 iters ahead, covers L2→L1 at ~8ns/iter = 16ns).
// T1@1536B (24 iters ahead, covers DRAM→L2 at ~80ns bare-metal).
...
// 4 independent per-pair accumulators + T0@128B (near, L1) + T1@1536B (far, DRAM→L2).
