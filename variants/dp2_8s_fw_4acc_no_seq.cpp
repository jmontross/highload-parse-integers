// dp2_8s_fw_4acc_no_seq.cpp — champion minus MADV_SEQUENTIAL.
// 8 streams with non-contiguous access patterns; MADV_SEQUENTIAL may trigger
// readahead that conflicts with multi-stream access. Test: drop sequential hint.
