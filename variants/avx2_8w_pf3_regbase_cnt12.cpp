// avx2_8w_pf3_regbase_cnt12.cpp
// Champion (avx2_8w_pf3_regbase) + explicit cnt==11,12 fast paths.
// Adds 2×pq+pp+pn for cnt==11 and 3×pq for cnt==12, removing the
// while-loop fallback for those cnt values.  Rare (~0.4% of windows
// each) but the SIMD dispatch may reduce BTB pressure.
