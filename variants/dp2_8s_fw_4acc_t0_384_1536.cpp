// dp2_8s_fw_4acc_t0_384_1536.cpp — 4acc, T0@384B + T1@1536B. T0=192 is champion; testing T0=384 (never tried for 4acc).
...
#define ITER_BODY(PFD) \
    _mm_prefetch((const char*)(p0 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p0 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p1 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p1 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p2 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p2 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p3 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p3 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p4 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p4 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p5 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p5 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p6 + 384), _MM_HINT_T0); \
    _mm_prefetch((const char*)(p6 + (PFD)), _MM_HINT_T1); \
    _mm_prefetch((const char*)(p7 + 384), _MM_HINT_T0); \
