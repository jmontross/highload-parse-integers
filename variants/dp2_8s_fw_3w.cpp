// dp2_8s_fw_3w — triple T1 prefetch per stream at PFD, PFD+32, PFD+64.
// nl_mask64 does two 32B AVX2 loads at p and p+32. Depending on (p+PFD)%64:
//   r in [1,31]: second load at PFD+32 can span into a THIRD cache line
//   not covered by T1@PFD or T1@PFD+32. T1@PFD+64 closes this gap.
// With r in [0]: all three prefetches hit 1-2 lines (slight redundancy, harmless).
// With r in [32,63]: 2 lines covered by T1@PFD + T1@PFD+32, T1@PFD+64 catches extra.
// Net: guarantees full coverage of all cache lines that nl_mask64(p+PFD) can touch.
// 24 T1 prefetches per iter (vs 16 for 2w) — modest overhead for complete coverage.
