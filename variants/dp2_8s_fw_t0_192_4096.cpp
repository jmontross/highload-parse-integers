// dp2_8s_fw_t0_192_4096.cpp — T0@192B + T1@4096B (64 CL ahead, ~1 full 4KB page)
// T0@192B (3 iters ahead, L2→L1) + T1@3072B (48 iters ahead, DRAM→L2).
// vs champion T0@512B: shorter T0 may work better when data is already in L2
// vs champion T0@192+T1@3072: longer far-tier DRAM prefetch (4096B vs 3072B).
