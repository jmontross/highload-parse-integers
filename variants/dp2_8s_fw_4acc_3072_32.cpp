// dp2_8s_fw_4acc_3072_32.cpp — 4 independent per-pair u16 accumulators + dual T1@3072+3072+32.
// Champion uses 4acc + T0@512B (near) + T1@3072B (far) = 16 prefetch µops/iter.
// dp2_8s_fw_3072_32 uses 1acc + T1@3072B + T1@3072+32B = 16 prefetch µops/iter.
// This combines 4acc independence (no serial chain) + dual T1 coverage (no T0 overhead).
// Theory: On this slow VM (T0 benefit < T0 µop cost), removing T0 and keeping +32 alignment
// coverage may give a cleaner inner loop vs the champion's T0+T1 approach.
...
// 4 independent per-pair u16 accumulators + dual T1@3072B and T1@3072+32B (no T0).
// Dual T1: covers both 32B AVX2 sub-loads of nl_mask64 at the prefetch target.
// Same 16 prefetch µops/iter as champion, but different geometry.
