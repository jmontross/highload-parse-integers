// dp2_8s_fw_2w_4acc.cpp — 4acc + dual T1@3072/3072+32 (covers both 32B halves).
// Combines 4 independent per-pair u16 accumulators (breaks 4-deep serial acc chain)
// with dual T1 prefetch (champion 2w innovation: nl_mask64 reads 2×32B; second 32B
// may be in a different cache line from the first, so second prefetch covers it).
// No T0 near prefetch — dual T1@3072 covers DRAM->L2; L2->L1 fill fast enough.
