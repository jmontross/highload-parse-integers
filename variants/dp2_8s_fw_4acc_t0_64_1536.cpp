// dp2_8s_fw_4acc_t0_64_1536.cpp — 4 independent per-pair u16 accumulators + T0@64+T1@1536.
// Judge tuning: T0@64B (1 iter, L2→L1) + T1@1536B (24 iters ahead, DRAM->L2).
// Judge (~80ns DRAM, 3GHz): 80ns × 3GHz = 240cy; 24 iters × 21cy = 504cy ≈ covers VM DRAM (300ns) at 1.6GHz.
// 1024B = 1.33× above theoretical min for LFB headroom for judge: DRAM latency / cycles_per_iter × cache_line_size.
// Gap between champion T1@1024B and T1@3072B; fills gap.
