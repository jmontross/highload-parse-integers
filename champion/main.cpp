// dp2_8s_fw_4acc_t0_64_768.cpp — 4 independent per-pair u16 accumulators + T0@64+T1@768.
// Judge tuning: T0@64B (1 iter, L2→L1) + T1@768B (12 iters ahead, DRAM→L2).
// Judge (~80ns DRAM, 3GHz): 80ns × 3GHz = 240cy; 12 iters × 21cy = 252cy ≈ exactly matches.
// 768B = theoretical optimum for judge: DRAM latency / cycles_per_iter × cache_line_size.
