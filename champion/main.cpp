// dp2_8s_fw_t0_256_768.cpp — double-loop + two-tier prefetch, SHORTER DISTANCES.
// T0@256B (4 iters=32ns, L1) + T1@768B (12 iters=96ns, matches bare-metal ~80-100ns DRAM).
